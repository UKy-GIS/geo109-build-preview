...
function makeMap(id) {
  ...
  if (basemaps[id]) {
    ...
    map.getPane("labels").style.zIndex = 401;
    L.tileLayer(
...
function addData(map, id) {
  fetch("https://boydx.github.io/hugo-maps/data/kentucky.geojson")
        ...
        .then((uk) => {
          const geojson = L.geoJson(uk, {
            ...
            onEachFeature: function (feature, layer) {
              ...
              let popup = `<h3>University of Kentucky</h3>
                          <span class="card-text display-5 font-weight-200">Lexington campus</span>`;
    ...
    .then(() => {
      if (id == "dsm" || id == "hill" || id == "loveletter") {
    ...
    .then((environs) => {
      geojson = L.geoJson(environs, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          csvData.forEach((d) => {
            if (d[0] == f.id) {
              popup += `<span class="card-text display-5 font-weight-200">${d[2]}</span><br>
              <span class="card-text display-6 font-weight-200">${d[3]}</span>`;
            }
          });
          layer.bindPopup(popup);
        },
    ...
    features: [
      {
        type: "Feature",
        properties: {
          amenity: "waterfountain.svg",
          size: [45, 45],
          name: "Thoroughbred Park",
          pop_up: "#",
        },
        geometry: { type: "MultiPoint", coordinates: [[-84.4904, 38.041601]] },
      },
      {
        type: "Feature",
        properties: {
        ...
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.495663, 38.046927]],
        },
      },
      {
        type: "Feature",
        properties: {
          amenity: "waterfountain.svg",
          size: [45, 45],
          name: "Limestone Curtain",
          pop_up: "#",
        },
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.496743, 38.046258]],
        },
      },
      {
        type: "Feature",
        ...
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.497247, 38.045936]],
        },
      },
      {
        type: "Feature",
        ...
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.499451, 38.047544]],
        },
      },
      {
        type: "Feature",
        ...
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.500739, 38.048949]],
        },
      },
      {
        type: "Feature",
        ...
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.494685, 38.044567]],
        },
      },
      {
        type: "Feature",
        properties: {
          amenity: "rainbow.svg",
          size: [80, 80],
          name: "Old wise one, knobbly and gnarled",
          pop_up: "#",
        },
        geometry: {
          type: "MultiPoint",
          coordinates: [[-84.500427, 38.032274]],
        },
      },
      {
        type: "Feature",
        ...
        geometry: { type: "MultiPoint", coordinates: [[-84.50337, 38.043482]] },
      },
      {
        type: "Feature",
        properties: {
          amenity: "ky_2.svg",
          size: [120, 120],
          name: "UKy Department of Geography<br><span style='font-size:0.8em;'>History — <a href='https://uky-gis.github.io/history/slides/'>visit</a></span>",
          pop_up: "#",
        },
        geometry: { type: "MultiPoint", coordinates: [[-84.50428, 38.038659]] },
      },
    ],
  };
